...
constexpr UInt32 OTG1_PIXEL_RATE_CNTL       = 0x0084; // regOTG1_PIXEL_RATE_CNTL（BASE_IDX=1）
constexpr UInt32 OTG2_PIXEL_RATE_CNTL       = 0x0088; // regOTG2_PIXEL_RATE_CNTL（BASE_IDX=1）
constexpr UInt32 OTG3_PIXEL_RATE_CNTL       = 0x008C; // regOTG3_PIXEL_RATE_CNTL（BASE_IDX=1）
...
// OTG_PIXEL_RATE_DIV__OTG1_PIXEL_RATE_DIVK1/K2（BASE_IDX=1）
constexpr UInt32 OTG1_PIXEL_RATE_DIVK1_SHIFT = 0x3;
constexpr UInt32 OTG1_PIXEL_RATE_DIVK1_MASK  = 0x00000008L;
constexpr UInt32 OTG1_PIXEL_RATE_DIVK2_SHIFT = 0x4;
constexpr UInt32 OTG1_PIXEL_RATE_DIVK2_MASK  = 0x00000030L;
// OTG_PIXEL_RATE_DIV__OTG2_PIXEL_RATE_DIVK1/K2（BASE_IDX=1）
constexpr UInt32 OTG2_PIXEL_RATE_DIVK1_SHIFT = 0x6;
constexpr UInt32 OTG2_PIXEL_RATE_DIVK1_MASK  = 0x00000040L;
constexpr UInt32 OTG2_PIXEL_RATE_DIVK2_SHIFT = 0x7;
constexpr UInt32 OTG2_PIXEL_RATE_DIVK2_MASK  = 0x00000180L;
// OTG_PIXEL_RATE_DIV__OTG3_PIXEL_RATE_DIVK1/K2（BASE_IDX=1）
constexpr UInt32 OTG3_PIXEL_RATE_DIVK1_SHIFT = 0x9;
constexpr UInt32 OTG3_PIXEL_RATE_DIVK1_MASK  = 0x00000200L;
constexpr UInt32 OTG3_PIXEL_RATE_DIVK2_SHIFT = 0xA;
constexpr UInt32 OTG3_PIXEL_RATE_DIVK2_MASK  = 0x00000C00L;
